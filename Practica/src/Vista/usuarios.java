...
public class usuarios extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Controlador.operaciones op = new Controlador.operaciones();
        Modelo.TablaEjemplo user = new Modelo.TablaEjemplo(txtNombre.getText(), txtApellido.getText(), Integer.parseInt(txtEdad.getText()));
        op.altaUsuarios(user);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       Controlador.operaciones op = new Controlador.operaciones();
        Modelo.TablaEjemplo user = new Modelo.TablaEjemplo(Integer.parseInt(txtId.getText()));
        op.bajaUsuarios(user);
